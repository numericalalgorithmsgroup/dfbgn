...
#         soln = dfbgn.solve(rosenbrock, x0, bounds=(lower, upper))
#         print(soln)
#         print(rosenbrock_jacobian(soln.x))
#         self.assertTrue(array_compare(soln.x, xmin, thresh=1e-2), "Wrong xmin")
#         self.assertTrue(array_compare(soln.resid, rosenbrock(soln.x), thresh=1e-10), "Wrong resid")
#         # self.assertTrue(array_compare(soln.jacobian, rosenbrock_jacobian(soln.x), thresh=1e0), "Wrong Jacobian")
...
#         self.assertTrue(array_compare(soln.x, xmin, thresh=1e-2), "Wrong xmin")
#         self.assertTrue(abs(soln.f - fmin) < 1e-4, "Wrong fmin")
#         # self.assertTrue(array_compare(soln.jacobian, jacmin, thresh=6e0), "Wrong jacobian")
